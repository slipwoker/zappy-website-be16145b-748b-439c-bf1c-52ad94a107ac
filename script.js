document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('click', function (e) {
    ...
    const navbarEl = document.querySelector('nav, header, .navbar, [data-navbar]');
  ...
  const navbar = document.querySelector('nav, header, .navbar, [data-navbar]');
  ...
  if (contactForm) {
    ...
    function showError(field, message) {
      ...
      const parent = field.closest('.form-group, .field-wrapper, .input-wrapper') || field.parentNode;
      ...
      fetch(action, {
        ...
        .then(function (response) {
          if (response.ok) {
            showFormSuccess();
            contactForm.reset();
            fields.forEach(function (field) { clearError(field); });
          } else {
        ...
        .catch(function (err) {
          const errorContainer = contactForm.querySelector('.form-general-error') || (function () {
          ...
          errorContainer.textContent = err.message || 'Something went wrong. Please try again.';
  ...
  const animatableEls = document.querySelectorAll(OBSERVED_SELECTORS);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'be16145b-748b-439c-bf1c-52ad94a107ac',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'be16145b-748b-439c-bf1c-52ad94a107ac';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'be16145b-748b-439c-bf1c-52ad94a107ac';
